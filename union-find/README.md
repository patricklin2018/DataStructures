...
| UnionFind3 | quick union 版本，基于 size 优化树深 h | [Java](https://github.com/patricklin2018/DataStructures-Algorithmns/blob/master/union-find/src/UnionFind3.java) |
...
```
N = 10000 次 union 和 isConnected 操作，消耗时间如下：
UnionFind1 : 113 ms
UnionFind2 : 87 ms
UnionFind3 : 24 ms
```